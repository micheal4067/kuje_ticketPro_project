...
const showBtn = document.getElementById("show_sidebar-btn");
const hideBtn = document.getElementById("hide_sidebar-btn");
...
document.addEventListener("click", (e) => {
  ...
  const clickedToggle = showBtn.contains(e.target) || hideBtn.contains(e.target);
